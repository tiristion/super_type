package core.controller.commands
{
	...
	public class ClearLevelCommand extends SimpleCommand
	{
		override public function execute(notification:INotification):void {
			var clearLevelDADO:PopupDoActionDO = new PopupDoActionDO(GeneralNotifications.RESTART_LEVEL,notification.getBody().levelId,GeneralNotifications.LEVEL_END,notification.getBody());
